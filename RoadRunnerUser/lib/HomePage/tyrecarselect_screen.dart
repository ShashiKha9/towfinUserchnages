...
class _TyreSelectScreenState extends State<TyreSelectScreen>
  ...
  String locationType;
  List<CarDataContentList> cardataContentList = List();
  CarDataContentList cardataContent= CarDataContentList();
        ...
        bottomNavigationBar:  Padding(
          ...
          child: ElevatedButton(
            ...
            onPressed: () async => {
              ...
              cardataContent.tyreOneSelected = _tireOneOpacity==1?true:false,
              cardataContent.tyreTwoSelected = _tireTwoOpacity==1?true:false,
              cardataContent.tyreThreeSelected = _tireThreeOpacity==1?true:false,
              cardataContent.tyreFourSelected = _tirefourOpacity==1?true:false,
              cardataContent.spairParts = isTowService?"Yes":"No",

              cardataContentList.add(cardataContent),
              optionsData.carDataContentList = cardataContentList,
