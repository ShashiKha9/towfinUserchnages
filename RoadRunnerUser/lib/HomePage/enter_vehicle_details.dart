        ...
        bottomNavigationBar: Padding(
          ...
          child: ElevatedButton(
            ...
            onPressed: () async => {
              ...
              optionsData.make = _makeController.text.toString(),
              optionsData.modal = _modalController.text.toString(),
              optionsData.color = _colorController.text.toString(),
              optionsData.vechileNo = _platNumberController.text.toString(),
