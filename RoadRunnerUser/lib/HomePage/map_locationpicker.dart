...
import 'package:roadrunner/Modals/AllProvidersList.dart';
...
final icon_Source = await BitmapDescriptor.fromAssetImage(
  ...
  _createPolylines(Position start, Position destination) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      "AIzaSyCu-gEfhthbqjZ3sZaWnVchOcETweUfoKc", // Google Maps API Key
...
// getlocation();
  ...
  getlocation() async {
    ...
    try{
      ...
      Position position = await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.medium,forceAndroidLocationManager: true);
                                                          ...
                                                          Row(
                                                              ...
                                                              children: [
                                                                new FadeInImage
                                                                  ...
                                                                  image: serviceImg!=null?serviceImg:'',
                                                                  width: width *
                                                                      0.15,
                                                                  height: height *
                                                                      0.08,
                                                ...
                                                child: Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        snapProvider.data.allServicesList.length>0?
                                                        ElevatedButton(
                                                          child: Padding(
                                                            padding:
                                                            EdgeInsets.only(
                                                        ...
                                                        Container(
                                                          ...
                                                          Column(
                                                            children: [
                                                              Text('Oops! No service provider for these services in your area. Please visit support to get immediate assistance.',style: TextStyle(fontFamily: AppTheme.fontName,fontSize: 15,color: AppTheme.white),textAlign: TextAlign.center,),
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                      Row(
                                                                        mainAxisSize: MainAxisSize.min,
                                                                        children: [
                                                                          Icon(Icons.quick_contacts_dialer_rounded,color: AppTheme.colorPrimary,),
                                                                          SizedBox(width: 10,),
                                                                          Text(
